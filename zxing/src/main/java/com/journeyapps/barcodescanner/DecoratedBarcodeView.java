...
import com.google.zxing.client.android.BarCodeDecodeHintManager;
...
public class DecoratedBarcodeView extends FrameLayout {
     ...
     *
     * @param intent the intent, as generated by BarCodeIntentIntegrator
     */
    public void initializeFromIntent(Intent intent) {
        // Scan the formats the intent requested, and return the result to the calling activity.
        Set<BarcodeFormat> decodeFormats = DecodeFormatManager.parseDecodeFormats(intent);
        Map<DecodeHintType, Object> decodeHints = BarCodeDecodeHintManager.parseDecodeHints(intent);
